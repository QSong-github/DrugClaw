...
```bash
python skills/drug_repurposing/repurposing_hub/repurposing_hub_skill.py <entity1> [entity2] ...
```

**Example:**
```bash
python skills/drug_repurposing/repurposing_hub/repurposing_hub_skill.py metformin
```
